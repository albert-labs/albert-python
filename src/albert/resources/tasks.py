...
class TaskInventoryInfo(BaseAlbertModel):
...
class BaseTask(BaseTaggedEntity):
    ...
    inventory_information: list[TaskInventoryInfo] = Field(alias="Inventories", default=None)
...
class PropertyTask(BaseTask):
    ...
    inventory_information : list[TaskInventoryInfo]
