...
_ = [
    {
        "name": "test-ctp-batch-with-templates",
        "category": "Batch",
        "Data": {
            "name": "TEST CUSTOM TEMPLATE - TAGS",
            "category": "Batch",
            "priority": "Low",
            "batchSizeUnit": "Kg",
            "Metadata": {
                "taskList2": [{"id": "LST65874", "name": "test1"}],
                "multi_list": [
                    {"id": "LST65881", "name": "a"},
                    {"id": "LST65882", "name": "b"},
                    {"id": "LST65883", "name": "c"},
                ...
                "Test_ETT_categoryST1": 1,
                "Test_ETT_categoryST2": "1",
                "AdcStrDEF5": "QA-4",
                "string_tedd": "sd",
                "string_tedd_5": "sdsfs",
                "ADVCTFSTRINV_1": "QA-4",
                ...
                "stringxyyy": "1",
                "ADVCTFMSTAS_1": [
                    {"id": "LST66250", "name": "232"},
                    {"id": "LST66080", "name": "hi"},
                ],
            },
            "Location": {"id": "LOC1375"},
            "Tags": [{"id": "TAG6264"}, {"id": "TAG9323"}],
            "AssignedTo": {"id": "USR4227"},
            "Project": {"id": "PROMO130903"},
            "Inventories": [{"id": "INVMO130903-019", "batchSize": 1}],
            "Workflow": [{"id": "WFL60801"}],
        },
    }
]
