    ...
    def import_curve_data(
        ...
        *,
        ...
        field_mapping : dict[str, str] | None, optional
            Optional manual mapping between CSV headers and curve result columns on the target column. Example: ``{"visc": "Viscosity"}`` maps the
            "visc" CSV header to the "Viscosity" curve result column name. Mappings are matched
            case-insensitively.
