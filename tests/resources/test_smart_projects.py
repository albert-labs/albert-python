...
from albert.resources.targets import ComparisonOperator, Target, TargetType, TargetValue
...
def test_add_target(
    ...
    target = Target(
        ...
        target_value=TargetValue(operator=ComparisonOperator.LTE, value=50),
        is_required=True,
    )
...
def test_update_smart_dataset(
    ...
    target_id = _add_new_target(
        ...
        Target(
            ...
            data_column_id=number_data_column.data_column_id,
            type=TargetType.PERFORMANCE,
            target_value=TargetValue(operator=ComparisonOperator.EQ, value=1),
            is_required=False,
        ),
    )
...
def test_remove_and_readd_target(
    ...
    target_id = _add_new_target(
        ...
        Target(
            ...
            data_column_id=number_data_column.data_column_id,
            type=TargetType.PERFORMANCE,
            target_value=TargetValue(operator=ComparisonOperator.GTE, value=1),
            is_required=False,
        ),
    )
